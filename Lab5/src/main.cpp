...
int main()
{
    try{
        ...
        Matrix m1(6,5);
        cout << "\nm1: " << endl;
        cout << "Wierszy: " << m1.rows() << endl;
        cout << "Kolumny: " << m1.cols() << endl;
        ...
        Matrix m2(6,5);
        cout << "\nm2: " << endl;
        cout << "Wierszy: " << m2.rows() << endl;
        cout << "Kolomny: " << m2.cols() << endl;
        ...
        Matrix m3(5);
        cout << "\nm3: " << endl;
        cout << "Wierszy: " << m3.rows() << endl;
        cout << "Kolomny: " << m3.cols() << endl;
